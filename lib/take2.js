...
const methods = {
  ...
  tags: {
    list()           { return this.get('tags'); },
    retrieve(id)     { return this.get(`tags/${id}`); }
  },
  manufacturingTags: {
    list()           { return this.get('manufacturingTags'); },
    retrieve(id)     { return this.get(`manufacturingTags/${id}`); }
  },
  carts: {
  ...
  products: {
    list()           { return this.get('products?filter[include]=tags&filter[include]=manufacturingTags'); },
  ...
  templates: {
    list()           { return this.get('templates?filter[include]=tags'); },
    retrieve(id)     { return this.get('templates/'+id); },
    create(data)     { return this.post('templates', data); },
    update(id, data) { return this.put('templates/'+id, data); },
    destroy(id)      { return this.del('templates/'+id); }
  },
  visitorTokens: {
